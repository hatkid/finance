(function($) {
	...
	if (!headerContextMenu) {
		...
		if (!fildOption.hidden) {
		    $('<div iconCls="icon-yes" field="' + fields[i] + '"/>')
    ...
    $.extend($.fn.treegrid.methods,
		...
		cascadeCheck : function(target, param) {
		    ...
		    selectChildren(target, param.id, idField,
	...
	$("<div/>").dialog(
		{
		    ...
		    buttons : [
				...
				iconCls : 'icon-add',
				handler : function() {
				    var currObj = $(this).closest('.panel')
					    .find('table');
				    currObj.find('tr:last').clone().appendTo(
					    currObj);
