	...
	<div class="rightinfo">
		<div class="easyui-layout" id="tb">
			<div>
				...
				<shiro:hasPermission name="personDel">
				...
				<span style="margin-left: 5px;display:inline;">姓名:<input id="name" data-options="validType:'length[1,25]'"
							class='easyui-textbox easyui-validatebox' style="line-height:26px;border:1px solid #ccc;height:22px;"></span>
				<span style="margin-left: 5px;display:inline;">联系方式:<input id='tel' data-options="validType:'length[1,25]'"
				...
				<span style="margin-left: 5px;display:inline;">身份证:<input data-options="validType:'length[1,32]'"
							class='easyui-textbox easyui-validatebox'
					id="idNumber" style="line-height:26px;border:1px solid #ccc;height:22px;"></span>
				<span style="margin-left: 5px;display:inline;">性别:<input type="radio" name="sex" value="男" />男 <input
					type="radio" name="sex" value="女" />女</span>
