...
<script type="text/javascript">
	...
	$(function() {
		...
		$grid = $dg.datagrid({
			...
			pagination : true,
			url : "manage/transport/searchByPageGoods",
			rownumbers : true,
			animate : true,
			fitColumns : true,
			striped : true,
...
<body>
	<div class="rightinfo">
		<div class="easyui-layout" id="tb">
			<div>
					<span style="margin-left: 5px;display:inline;"> 起运省份: <input id="startProvince" style="line-height:26px;border:1px solid #ccc;height:22px;"/></span>
					<span style="margin-left: 5px;display:inline;"> 目的省份: <input id="endProvince" style="line-height:26px;border:1px solid #ccc;height:22px;"/></span>
