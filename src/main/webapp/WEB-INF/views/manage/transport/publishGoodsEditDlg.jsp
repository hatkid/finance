...
<script type="text/javascript">
    $(function () {
        $("#form").form({
            url: "manage/transport/publishGoodsSave",
            onSubmit: function () {
                $.messager.progress({
                    title: '提示',
                    text: '数据处理中，请稍后....'
                ...
                <table>
                   ...
                   <tr>
                    ...
                    <tr>
                        <th>货物详情</th>
                        <td>
                        	<input id="details" name="goodsDetails" type="text" class="easyui-textbox easyui-validatebox" data-options="validType:'length[1,200]'"
                                   required="required"/>
                        </td>
                        <th>车辆要求</th>
                        <td>
                        	<input id="vehicleLoad" name="vehicleLoad" type="text" class="easyui-textbox easyui-validatebox" data-options="validType:'length[1,11]'"
                                   required="required"/>
                        </td>
                    </tr>
