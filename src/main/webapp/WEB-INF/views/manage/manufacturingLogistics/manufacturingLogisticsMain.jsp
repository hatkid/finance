...
<script type="text/javascript">
	...
	$(function() {
		...
		$grid = $dg.datagrid({
			...
			pagination : true,
			url : "manage/manufacturingLogistics/searchByPage",
			rownumbers : true,
			animate : true,
			fitColumns : true,
			striped : true,
			...
			columns : [ [{
				...
				field : 'selfRunLogisticsTotalCost',
				title : '自营物流总费用（万元）（不含企业采购费和物流外包费）',
				align : 'left',
				editor : 'text'
			}, {
				field : 'storageType',
		...
		$("#add").click(function() {
			$.modalDialog({
				...
				width : 700,
				height : 600,
				href : "manage/manufacturingLogistics/editDlg",
				buttons : [ {
					text : '保存',
					iconCls : 'icon-yes',
					handler : function() {
		...
		$("#delete").click(function() {
			...
			if (node) {
				...
				$.messager.confirm("提示", "确定要删除记录吗?", function(result) {
					if (result) {
						$.ajax({
							url : "manage/manufacturingLogistics/delete",
							data : {
								'id' : node.id
							},
							method : "POST",
...
<body onload="load()">
	<div class="rightinfo">
		<div class="easyui-layout" id="tb">
			...
			<div>
				<shiro:hasPermission name="manufacturingLogisticsAdd">
				...
				<shiro:hasPermission name="manufacturingLogisticsEdit">
					<span id="update" class="mystyle"><img
						src="resources/core/images/t02.png"
						style="vertical-align:middle; margin-left: 5px;padding-left:5px;" />
						修改</span>
				</shiro:hasPermission>
				<shiro:hasPermission name="manufacturingLogisticsDel">
					<span id="delete" class="mystyle"><img
						src="resources/core/images/t03.png"
						style="vertical-align:middle; margin-left: 5px;padding-left:5px;" />
						删除</span>
				</shiro:hasPermission>
				<shiro:hasPermission name="manufacturingLogisticsExport">
					<span id="export" class="mystyle"><img
						src="resources/core/images/excel.png"
						style="vertical-align:middle; margin-left: 5px;padding-left:5px;" />
						导出</span>
				</shiro:hasPermission>
				<shiro:hasPermission name="manufacturingLogisticsUpload">
			...
			<div style="display:none;">
				<form action="manage/manufacturingLogistics/download" method="get"
					id="download">
		...
		<table class="tablelist" id="dg" title="制造类物流企业信息统计"></table>
