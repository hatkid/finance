...
<script type="text/javascript">
	...
	$(function() {
		...
		$grid = $dg.datagrid({
			...
			pagination : true,
			url : "manage/gardenLogistics/searchByPage",
			rownumbers : true,
			animate : true,
			fitColumns : true,
			striped : true,
		...
		$("#add").click(function() {
			$.modalDialog({
				...
				width : 700,
				height : 600,
				href : "manage/gardenLogistics/editDlg",
				buttons : [ {
					text : '保存',
					iconCls : 'icon-yes',
					handler : function() {
		...
		$("#delete").click(function() {
			...
			if (node) {
				...
				$.messager.confirm("提示", "确定要删除记录吗?", function(result) {
					if (result) {
						$.ajax({
							url : "manage/gardenLogistics/delete",
							data : {
								'id' : node.id
							},
							method : "POST",
...
<body onload="load()">
	<div class="rightinfo">
		<div class="easyui-layout" id="tb">
			...
			<div>
				<shiro:hasPermission name="gardenLogisticsAdd">
				...
				<br /> <span style="margin-left: 5px;display:inline;"> 园区名称:
					<input id='companyName' data-options="validType:'length[1,100]'"
							class='easyui-textbox easyui-validatebox'
							type='text' />
				</span> <span style="margin-left: 5px;display:inline;"> 企业法人: <input id='legalPerson' data-options="validType:'length[1,100]'"
			...
			<div style="display:none;">
				<form action="manage/gardenLogistics/download" method="get"
					id="download">
		...
		<table class="tablelist" id="dg" title="物流园区信息统计"></table>
