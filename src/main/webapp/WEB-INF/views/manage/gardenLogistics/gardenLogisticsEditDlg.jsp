...
<script type="text/javascript">
	$(function() {
		$("#form").form({
			url : "manage/gardenLogistics/saveOrUpdate",
			onSubmit : function() {
				$.messager.progress({
					title : '提示',
					text : '数据处理中，请稍后....'
		...
		<form id="form" method="post">
			<fieldset>
				...
				<table>
					...
					<tr>
						<th>法人代表</th>
						<td><input name='legalPerson' id='legalPerson' required='required' data-options="validType:'length[1,100]'"
							class='easyui-textbox easyui-validatebox' type='text' />
						</td>
						<th>联系电话</th>
					...
					<tr>
						...
						<th>获得荣誉</th>
						<td><input name='achieveDistinction' id='achieveDistinction' data-options="validType:'length[1,100]'"
							class='easyui-textbox easyui-validatebox' type='text' />
						</td>
					</tr>
					<tr>
						<th>园区类别</th>
						<td><input name='gardenType' id='gardenType' data-options="validType:'length[1,100]'"
							class='easyui-textbox easyui-validatebox' type='text' />
						</td>
						<th>园区内企业数（个）</th>
						<td><input name='cmpNumInGarden' id='cmpNumInGarden' data-options="validType:'length[1,6]'"
					...
					<tr>
						<th>园区入住率（%）</th>
						<td><input name='occupancyRate' id='occupancyRate' size='26' data-options="validType:'length[1,6]'"
							class='easyui-numberbox'  type='text' />
						</td>
						<th>是否有信息平台</th>
