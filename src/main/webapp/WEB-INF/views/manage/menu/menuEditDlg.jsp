        ...
        <form id="form" method="post">
            <fieldset>
                ...
                <table>
                    <tr>
                        <th>菜单名称</th>
                        <td><input name="name" id="name" placeholder="请输入菜单名称" class="easyui-textbox easyui-validatebox"
                                   type="text"/></td>
                        <th>父菜单名称</th>
                    ...
                    <tr>
                        <th>菜单类型</th>
                        <td>
                            <select id="type" class="easyui-combobox" name="type" style="width:171px;"
                        ...
                        <th>是否启用</th>
                        <td><select id="isused" class="easyui-combobox" name="isused" style="width:171px;"
                                    data-options="required:true">
